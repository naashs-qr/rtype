...
#include "GameEngine/RType/Button/SoundButton.hpp"
...
engine::rtype::SoundButton::SoundButton()
{
    this->entity = ::ecs::Coordinator::getInstance().createEntity();
    ecs::Entity next = CheatButton::construct(this->entity);
    ecs::Entity prev = SoundButton::getEsc(next);
    ...
    ::ecs::Coordinator::getInstance().addComponent(
        this->entity, 
        ecs::Button {
            .click = &SoundButton::click,
            .hover = &SoundButton::hover,
            .resetHover = &SoundButton::resetHover,
            .next = next,
            .isHover = false,
            .isClic =  false,
            .isEsc = false,
...
::ecs::Entity engine::rtype::SoundButton::click(ecs::Entity entity)
{
...
void engine::rtype::SoundButton::hover(ecs::Entity entity)
{
    ecs::SpriteAnimation &animation = ecs::Coordinator::getInstance().getComponent<ecs::SpriteAnimation>(entity);
...
void engine::rtype::SoundButton::resetHover(ecs::Entity entity)
{
    ecs::SpriteAnimation &animation = ecs::Coordinator::getInstance().getComponent<ecs::SpriteAnimation>(entity);
