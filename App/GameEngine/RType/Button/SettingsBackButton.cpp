...
engine::rtype::SettingsBackButton::SettingsBackButton(::ecs::Entity prev = ::ecs::MAX_ENTITIES + 1, ::ecs::Entity first = ::ecs::MAX_ENTITIES + 1)
{
    ...
    ::ecs::Coordinator::getInstance().addComponent(
        this->entity, 
        ecs::Button {
            .click = &SettingsBackButton::click,
            .hover = &SettingsBackButton::hover,
            .resetHover = &SettingsBackButton::resetHover,
            .next = first,
            .isHover = false,
            .isClic = false,
            .isEsc = true,
...
::ecs::Entity engine::rtype::SettingsBackButton::click(ecs::Entity entity) 
{
...
void engine::rtype::SettingsBackButton::hover(ecs::Entity entity)
{
...
void engine::rtype::SettingsBackButton::resetHover(ecs::Entity entity)
{
    ecs::SpriteAnimation &animation = ecs::Coordinator::getInstance().getComponent<ecs::SpriteAnimation>(entity);
