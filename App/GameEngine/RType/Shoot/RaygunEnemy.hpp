...
class RaygunEnemy : public ::engine::Projectile {
    public:
        ...
        static ::ecs::Entity fire(::game::Vector2 &pos, short lvl, ::game::Vector2 target, ecs::CollisionType type) {
            ::engine::rtype::RaygunEnemy projectile(type, lvl);
        ...
        RaygunEnemy(ecs::CollisionType type = ecs::CollisionType::COL_PROJECTILE_ENEMY, short lvl = 0, ::game::Vector2 pos = {0, 0}) : ::engine::Projectile(pos)
        {
