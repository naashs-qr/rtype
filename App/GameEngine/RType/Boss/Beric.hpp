...
*/
    ...
    #include "GameEngine/RType/Shoot/MultiBullet.hpp"
    #include "GameEngine/RType/Shoot/MultiBullet2.hpp"
    ...
    class Beric : public engine::Boss {
        public: 
            ...
            Beric()
                ...
                ::ecs::Coordinator::getInstance().addComponent(
                    ...
                    ecs::Shoot {
                        ...
                        .target = 0,
                        .shots = {},
                        .fire = &engine::rtype::MultiBullet::fire,  
                ...
                ::ecs::Coordinator::getInstance().addComponent(
                    this->entity,
                    ecs::AI {
                        .move  = {ecs::AIMoveType::AIMOV_STRAIGHT, {0, 0}, 0, {0, 0}, false, &engine::rtype::AI::move},
                        .shoot = {},
                        .lifeTime = 0
                });
                ...
                this->bericAction = {
                    ...
                    {BericActionType::MOVE2, &engine::rtype::Beric::MoveUpDown},
                    {BericActionType::REPLACE, &engine::rtype::Beric::replace},
                    {BericActionType::REPLACE2, &engine::rtype::Beric::replace2},
                    {BericActionType::WAIT, &engine::rtype::Beric::waiting}
                };

                this->action = bericAction.at(BericActionType::WAIT);
                this->nbReps = -1;
            };
            ~Beric() = default;

            static void waiting(engine::Boss* beric) {
                ...
                if (beric->nbReps == 0) {
                    beric->nbReps = 1;
                    ai.move = {ecs::AIMoveType::AIMOV_STRAIGHT, {-50, 0}, 0, {0, 0}, false, &engine::rtype::AI::move},
                    beric->action = bericPtr->bericAction.at(BericActionType::ENTRANCE);
                }
                else
                    return;
            }
            ...
            static void entrance(engine::Boss* beric) {
                ...
                ecs::Alive &alive = ecs::Coordinator::getInstance().getComponent<ecs::Alive>(bericPtr->entity);


                if (trans.position.x <= 1000) {
            ...
            static void replace(engine::Boss* beric) {
                ...
                engine::rtype::Beric *bericPtr = static_cast<engine::rtype::Beric *>(beric);
                ecs::Transform &trans = ecs::Coordinator::getInstance().getComponent<ecs::Transform>(bericPtr->entity);
                ecs::RigidBody &body = ecs::Coordinator::getInstance().getComponent<ecs::RigidBody>(bericPtr->entity);

                ecs::AI &ai = ecs::Coordinator::getInstance().getComponent<ecs::AI>(beric->entity);
                ai.move  = {ecs::AIMoveType::AIMOV_STRAIGHT, {200, 0}, 0, {1600, 400}, false, &engine::rtype::AI::move};

                // if (beric->nbReps == 0) {
                //     // beric->action = beric->bericAction.at(BericActionType::MULTISHOOT2);
                //     beric->nbReps = 1;
                //     beric->action = bericPtr->bericAction.at(BericActionType::MOVE2);
                // }

                if (trans.position.x > 1500) {
                    ai.move.val.a = 0;
                    ai.move.val.b = 0;
                    body.velocity *= 0;
            ...
            static void replace2(engine::Boss* beric) {
                // std::cout << "replace2222" << std::endl;
                engine::rtype::Beric *bericPtr = static_cast<engine::rtype::Beric *>(beric);
                ecs::Transform &trans = ecs::Coordinator::getInstance().getComponent<ecs::Transform>(bericPtr->entity);
                ecs::Shoot &shoot = ecs::Coordinator::getInstance().getComponent<ecs::Shoot>(bericPtr->entity);
                ecs::AI &ai = ecs::Coordinator::getInstance().getComponent<ecs::AI>(beric->entity);
                ai.move  = {ecs::AIMoveType::AIMOV_STRAIGHT, {0, 0}, 0, {1700, 400}, false, &engine::rtype::AI::moveTo};
                float dirct;
            ...
            static void MultiSoot1(engine::Boss* beric) {
                ...
                shoot.fire = &engine::rtype::MultiBullet::fire;
            ...
            static void MultiShoot2(engine::Boss* beric) {
                ...
                shoot.fire = &engine::rtype::MultiBullet2::fire;
                ...
                if (beric->nbReps == 0) {
                    // beric->action = beric->bericAction.at(BericActionType::MULTISHOOT2);
                    beric->nbReps = 200;
                    beric->action = bericPtr->bericAction.at(BericActionType::REPLACE2);
                }
                beric->nbReps--;
            }

            static void MoveCircle(engine::Boss* beric) {
                // std::cout << "MoveCircle" << std::endl;
                engine::rtype::Beric *bericPtr = static_cast<engine::rtype::Beric *>(beric);
                ecs::AI &ai = ecs::Coordinator::getInstance().getComponent<ecs::AI>(beric->entity);
            ...
            static void MoveUpDown(engine::Boss* beric) {
                // std::cout << "MultiSoot4" << std::endl;
                engine::rtype::Beric *bericPtr = static_cast<engine::rtype::Beric *>(beric);
                ecs::AI &ai = ecs::Coordinator::getInstance().getComponent<ecs::AI>(beric->entity);
                ecs::Shoot &shoot = ecs::Coordinator::getInstance().getComponent<ecs::Shoot>(bericPtr->entity);
                ai.move  = {ecs::AIMoveType::AIMOV_STRAIGHT, {-1.0, 100.0}, 0, {0, 0}, false, &engine::rtype::AI::moveUpDown},
                beric->action = bericPtr->bericAction.at(BericActionType::MULTISHOOT2);
                shoot.rate = 1.5;
                shoot.delay = 1.5;
                beric->nbReps = 1000;
            }
