...
*/
    ...
    #include "App/GameEngine/RType/Sound/Sound.hpp"
    #include <map>
    #include <queue>
    #include <iostream>
    #include <utility>
...
namespace engine {
    ...
    const std::map<int, std::array<engine::EntityType, 3>> shaderTypes = {
        std::make_pair<int, std::array<engine::EntityType, 3>>(0, {engine::EntityType::SPOT_SHAD , engine::EntityType::WAVE_SHAD , engine::EntityType::SPACE_PARALLAX}),
        ...
        std::make_pair<int, std::array<engine::EntityType, 3>>(2, {engine::EntityType::SPOT_SHAD , engine::EntityType::WAVE_SHAD , engine::EntityType::SPACE_PARALLAX}),
    ...
    class Theme {
        public:
            ...
            void load(int lvl) {
                ...
                this->ambiantShaderPtr = engine::EntityFactory::createEngineEntity(shaderTypes.at(lvl)[0]);
                this->textureShaderPtr = engine::EntityFactory::createEngineEntity(shaderTypes.at(lvl)[1]);
                // this->ambiantShaderPtr.swap(ptr1); 
                // this->textureShaderPtr.swap(ptr2);
